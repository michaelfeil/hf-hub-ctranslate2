...
def convert(NAME="opus-mt-en-fr", ORG="Helsinki-NLP", description="generator"):
    ...
    HUB_NAME = f"{NAME}-ct2-int8"
    repo_id = f"OpenNMT/{HUB_NAME}"
    ...
    vmap = None, 
    quantization={'"int8"'  if description != "encoder" else None},
    force = True,
)
"""
...
# Original description, copied from https://huggingface.co/{ORG}/{NAME}
    """
